...
[CreatedDate] [datetime2] NOT NULL CONSTRAINT [DF_Physicians_CreatedDate] DEFAULT (sysdatetime()),
[UpdatedDate] [datetime2] NOT NULL CONSTRAINT [DF_Physicians_UpdatedDate] DEFAULT (sysdatetime()),
