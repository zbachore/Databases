...
[CreatedDate] [datetime2] NOT NULL CONSTRAINT [DF_AnalyticMetricMapping_CreatedDate] DEFAULT (sysdatetime()),
[UpdatedDate] [datetime2] NOT NULL CONSTRAINT [DF_AnalyticMetricMapping_UpdatedDate] DEFAULT (sysdatetime())
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [edw].[AnalyticMetricMapping] ADD CONSTRAINT [FK_AnalyticMetricMapping_Metric] FOREIGN KEY ([MetricKey]) REFERENCES [edw].[Metric] ([MetricKey])
GO
