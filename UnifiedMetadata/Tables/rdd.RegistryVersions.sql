...
[StartDate] [datetime2] NOT NULL CONSTRAINT [DF_RegistryVersions_StartDate] DEFAULT (CONVERT([datetime],CONVERT([varchar],getdate(),(1)),(1))),
...
GO
ALTER TABLE [rdd].[RegistryVersions] ADD CONSTRAINT [FK_RegistryVersion_Registry] FOREIGN KEY ([RegistryId]) REFERENCES [rdd].[Registries] ([RegistryId])
GO
