...
--  exec [dbo].[CreateProjectAssociationForRelatishipTable] 'dbo.ProjectValueSetsTaxonomy', '243','-1','ValueSetId','TaxonId','cdd.ValueSets_Taxonomy','ValueSetsTaxonomyID',4,'Sanjit Prasad','Inserted',null,1
-- =============================================
CREATE PROCEDURE [dbo].[CreateProjectAssociationForRelatishipTable] 
