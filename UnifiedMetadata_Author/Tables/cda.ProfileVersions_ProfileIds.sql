...
[ProfileVersionsProfileIdsID] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [cda].[ProfileVersions_ProfileIds] ADD CONSTRAINT [FK__ProfileVe__Profi__381A47C8] FOREIGN KEY ([ProfileVersionId]) REFERENCES [cda].[ProfileVersions] ([ProfileVersionId])
GO
