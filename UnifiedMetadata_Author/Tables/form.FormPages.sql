...
(
[FormPageId] [int] NOT NULL IDENTITY(1, 1),
[FormId] [int] NOT NULL,
...
[IsRepeatable] [bit] NOT NULL CONSTRAINT [DF_FormPages_IsRepeatable] DEFAULT ((0)),
[DisplayOrder] [int] NOT NULL CONSTRAINT [DF_FormPages_DisplayOrder] DEFAULT ((0)),
...
GO
ALTER TABLE [form].[FormPages] ADD CONSTRAINT [FK_FormPages_FormPages] FOREIGN KEY ([ParentFormPageId]) REFERENCES [form].[FormPages] ([FormPageId])
GO
ALTER TABLE [form].[FormPages] ADD CONSTRAINT [FK_FormPages_Forms] FOREIGN KEY ([FormId]) REFERENCES [form].[Forms] ([FormId])
GO
