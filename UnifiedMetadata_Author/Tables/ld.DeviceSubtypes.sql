...
(
[DeviceSubtypeId] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [ld].[DeviceSubtypes] ADD CONSTRAINT [FK_DeviceSubtypes_DeviceTypes] FOREIGN KEY ([DeviceTypeId]) REFERENCES [ld].[DeviceTypes] ([DeviceTypeId])
GO
