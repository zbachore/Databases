...
[FormSectionConstraintDefintitionsID] [int] NOT NULL IDENTITY(1, 1)
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [form].[FormSectionConstraintDefintitions] ADD CONSTRAINT [FK_FormSectionConstraintDefintitions_ConstraintDefinitions] FOREIGN KEY ([ConstraintDefinitionId]) REFERENCES [dd].[ConstraintDefinitions] ([ConstraintDefinitionId])
GO
ALTER TABLE [form].[FormSectionConstraintDefintitions] ADD CONSTRAINT [FK_FormSectionConstraintDefintitions_FormSections] FOREIGN KEY ([FormSectionId]) REFERENCES [form].[FormSections] ([FormSectionId])
GO
