...
GO
ALTER TABLE [dbo].[Project] ADD CONSTRAINT [PK__Project__761ABEF0319E528A] PRIMARY KEY CLUSTERED  ([ProjectId]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Project] ADD CONSTRAINT [unique_Project_ProjectName] UNIQUE NONCLUSTERED  ([ProjectName]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Project] ADD CONSTRAINT [FK_Project_ProjectStatusId] FOREIGN KEY ([ProjectStatusId]) REFERENCES [dbo].[ProjectStatus] ([ProjectStatusId])
GO
