...
(
[ConceptSynonymId] [int] NOT NULL IDENTITY(1, 1),
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Contains any number of synonymous names (descriptions) for the Concepts.', 'SCHEMA', N'cdd', 'TABLE', N'ConceptSynonyms', NULL, NULL
GO
