...
(
[ConceptDefinitionId] [int] NOT NULL IDENTITY(1, 1),
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Contains all the definition for the Concept and the source from which it came.  ', 'SCHEMA', N'cdd', 'TABLE', N'ConceptDefinitions', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_Description', N'Defines the type of definition.', 'SCHEMA', N'cdd', 'TABLE', N'ConceptDefinitions', 'COLUMN', N'ConceptDefinitionTypeId'
GO
