...
GO
ALTER TABLE [cdd].[DataElements_Taxonomy] ADD CONSTRAINT [FK_DataElement_Taxonomy] FOREIGN KEY ([DataElementId]) REFERENCES [cdd].[DataElements] ([DataElementId])
GO
ALTER TABLE [cdd].[DataElements_Taxonomy] ADD CONSTRAINT [FK_DataElement_Taxonomy_Taxonomy] FOREIGN KEY ([TaxonId]) REFERENCES [dd].[Taxonomy] ([TaxonId])
GO
