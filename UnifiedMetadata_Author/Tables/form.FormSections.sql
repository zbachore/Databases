...
[DisplayOrder] [int] NOT NULL CONSTRAINT [DF_FormSections_DisplayOrder] DEFAULT ((0)),
...
GO
ALTER TABLE [form].[FormSections] ADD CONSTRAINT [FK_FormSections_FormElements] FOREIGN KEY ([DynamicFormElementId]) REFERENCES [form].[FormElements] ([FormElementId])
GO
ALTER TABLE [form].[FormSections] ADD CONSTRAINT [FK_FormSections_FormSections] FOREIGN KEY ([ParentFormSectionId]) REFERENCES [form].[FormSections] ([FormSectionId])
GO
ALTER TABLE [form].[FormSections] ADD CONSTRAINT [FK_FormSections_Pages] FOREIGN KEY ([FormPageId]) REFERENCES [form].[FormPages] ([FormPageId])
GO
