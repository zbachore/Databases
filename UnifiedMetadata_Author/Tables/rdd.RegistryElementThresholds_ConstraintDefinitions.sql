...
GO
ALTER TABLE [rdd].[RegistryElementThresholds_ConstraintDefinitions] ADD CONSTRAINT [FK_RegistryElementThresholds_ConstraintDefinitions_ConstraintDefinitions] FOREIGN KEY ([ConstraintDefinitionId]) REFERENCES [dd].[ConstraintDefinitions] ([ConstraintDefinitionId])
GO
ALTER TABLE [rdd].[RegistryElementThresholds_ConstraintDefinitions] ADD CONSTRAINT [FK_RegistryElementThresholds_ConstraintDefinitions_RegistryElementThresholds] FOREIGN KEY ([RegistryElementThresholdId]) REFERENCES [rdd].[RegistryElementThresholds] ([RegistryElementThresholdId])
GO
