...
(
[TaxonId] [int] NOT NULL IDENTITY(1, 1),
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'Taxonomy table is use to orderly classify and organize the content of any table within a hierarchical structure.', 'SCHEMA', N'dd', 'TABLE', N'Taxonomy', NULL, NULL
GO
