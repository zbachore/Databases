...
(
[ProfileIdId] [int] NOT NULL IDENTITY(1, 1),
...
GO
ALTER TABLE [cda].[ProfileIds] ADD CONSTRAINT [PK__ProfileI__A9D5C2F3607251E5] PRIMARY KEY CLUSTERED  ([ProfileIdId]) ON [PRIMARY]
GO
