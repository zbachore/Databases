...
OUTPUT  
	...
	CASE WHEN deleted.RegistryDataSetId IS NULL AND Inserted.RegistryDataSetId IS NOT NULL THEN 'Inserted'
	WHEN deleted.RegistryDataSetId IS NOT NULL AND Inserted.RegistryDataSetId IS NOT NULL THEN 'Updated'
	ELSE NULL END,
	'Publish',
	@RequestedTime, 
	SYSDATETIME()
