...
CREATE PROCEDURE [cdd].[pr_PublishValueSetDeviceMembers] @ProjectID int, @PublishQueueID int AS 
BEGIN
...
Description:	Defines cdd.pr_PublishValueSetDeviceMembers stored procedure
___________________________________________________________________________________________________
Example: EXEC cdd.pr_PublishValueSetDeviceMembers 3,1
___________________________________________________________________________________________________
Revision History
Date			Author			Reason for Change
02/22/2018     rkakani		Added DISTINCT keyword to removed duplicates from Source
02/22/2018     rkakani		Removed columns vsdm.CreatedDate,vsdm.UpdatedDate from the source as these fields are not required 
-------	 ------- -----------------------------------------------------------------------
***************************************************************************************************/
...
BEGIN CATCH
    ...
    SET @ErrorMessage = 'cdd.pr_PublishValueSetDeviceMembers:' + ERROR_MESSAGE();
