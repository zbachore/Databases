...
CREATE PROCEDURE [ld].[pr_PublishDeviceSubtypes] @ProjectID int, @PublishQueueID int AS 
BEGIN
...
Description:	Defines ld.pr_PublishDeviceSubtypes stored procedure
___________________________________________________________________________________________________
Example: EXEC ld.pr_PublishDeviceSubtypes 3,1
___________________________________________________________________________________________________
Revision History
...
BEGIN CATCH
    ...
    SET @ErrorMessage = 'ld.pr_PublishDeviceSubtypes:' + ERROR_MESSAGE();
